...
if (window.history && window.history.pushState) {
  $(window).on('popstate', function () {
    ...
    window.location.href = 'register_healthcare_professional.jsp';
  });
...
.sub-menu li a:hover {
  ...
  <div class="bg-light text-center rounded p-5" style="background-color: #f8f9fa;">
    <h1 class="mb-4" style="color: #333;">Registration Form</h1>
     <h2 style="color: #007bff;">Healthcare Professional Registration Form</h2>

    <form id="registrationForm" action="RegisterProfessionalServlet" method="post">
      <div style="margin-bottom: 15px;">
        <label for="name" style="color: #333;">Name:</label><br>
        <input type="text" id="name" name="name" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;">
      </div>

      <div style="margin-bottom: 15px;">
        <label for="email" style="color: #333;">Email:</label><br>
        <input type="email" id="email" name="email" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;">
      </div>

      <div style="margin-bottom: 15px;">
        <label for="password" style="color: #333;">Password:</label><br>
        <input type="password" id="password" name="password" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;">
      </div>

      <div style="margin-bottom: 15px;">
        <label for="confirm_password" style="color: #333;">Confirm Password:</label><br>
        <input type="password" id="confirm_password" name="confirm_password" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;">
      </div>

      <div style="margin-bottom: 15px;">
  <label for="profession" style="color: #333;">Profession:</label><br>
  <select id="profession" name="profession" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;">
    ...
    <option value="orthologist">Orthologist</option>
      ...
      <div style="margin-bottom: 15px;">
        <label for="bio" style="color: #333;">Bio:</label><br>
        <textarea id="bio" name="bio" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;"></textarea>
      </div>

      <div style="margin-bottom: 15px;">
        <label for="role" style="color: #333;">Role:</label><br>
        <select name="role" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;">
      ...
      <div style="margin-bottom: 15px;">
        <label for="location" style="color: #333;">Location:</label><br>
        <input type="text" id="location" name="location" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;">
      </div>

      <div style="margin-bottom: 15px;">
        <label for="availability" style="color: #333;">Availability:</label><br>
        <input type="text" id="availability" name="availability" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;">
      </div>

      <button type="submit" style="padding: 10px 20px; background-color: #007bff; border: none; color: #fff; border-radius: 4px; cursor: pointer;">Register</button>
    </form>
  </div>
</div>
