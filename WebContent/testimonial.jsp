                ...
                <div class="col-lg-8">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item text-center">
                            ...
                            <p class="fs-4 fw-normal">I had a wonderful experience at XYZ Medical Center. Dr. Johnson and his team were incredibly knowledgeable and caring. They took the time to explain everything in detail and made sure I felt comfortable throughout my treatment. The staff was friendly and efficient, and the facility was clean and modern. I highly recommend XYZ Medical Center for anyone seeking top-notch medical care.</p>
                        ...
                        <div class="testimonial-item text-center">
                            ...
                            <p class="fs-4 fw-normal">I recently visited LMN Physiotherapy Clinic for a sports injury, and I couldn't be happier with the results. The physiotherapist, Emily, was fantastic. Her expertise and personalized approach helped me recover quickly and regain my strength. The clinic had excellent facilities, and the staff was professional and attentive. I'm grateful for the outstanding care I received at LMN Physiotherapy Clinic.</p>
                            <hr class="w-25 mx-auto">
                            <h3>John Anderson</h3>
                        ...
                        <div class="testimonial-item text-center">
                            ...
                            <p class="fs-4 fw-normal">As someone with dental anxiety, I'm pleased to say that my experience at ABC Dental Care was exceptional. Dr. Davis was patient, gentle, and understanding throughout the entire procedure. The dental hygienist, Jessica, was also fantastic. The clinic was clean, and the equipment was up to date. The entire team went above and beyond to make me feel comfortable. I highly recommend ABC Dental Care for anyone seeking a caring and professional dental practice.</p>
                            <hr class="w-25 mx-auto">
                            <h3>Lisa Roberts</h3>
                            <h6 class="fw-normal text-primary mb-3">Accountant</h6>
                        </div>
                           <div class="testimonial-item text-center">
                            <div class="position-relative mb-5">
                                <img class="img-fluid rounded-circle mx-auto" src="img/testimonial-3.jpg" alt="">
                            ...
                            <p class="fs-4 fw-normal">I recently had LASIK surgery at PQR Eye Clinic, and it was life-changing. Dr. Martinez and his team were outstanding. They provided thorough pre-operative consultations, explaining the procedure and addressing all my concerns. The surgery itself was quick and painless, and the results are incredible. The staff at PQR Eye Clinic were friendly, organized, and ensured a smooth experience from start to finish. I'm grateful for their expertise and highly recommend PQR Eye Clinic for anyone considering vision correction.</p>
                            <hr class="w-25 mx-auto">
                            <h3>Michael Johnson</h3>
                            <h6 class="fw-normal text-primary mb-3">Sales Representative</h6>
                        </div>
                    </div>
                </div>
            </div>
