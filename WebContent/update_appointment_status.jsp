...
try {
    ...
    String updateQuery = "UPDATE appointments SET appointment_status = '" + status + "' WHERE id = " + appointmentId;
...
%>
<script>
    // Redirect the healthcare professional back to the appointments page after updating the status
