...
<div class="col-lg-6">
  <div class="bg-light text-center rounded p-5" style="background-color: #f8f9fa;">
    <h1 class="mb-4" style="color: #333;">Login</h1>
    ...
    <form id="loginForm" method="post">
      ...
      <div style="margin-bottom: 15px;">
        <label for="role" style="color: #333;">Login as:</label><br>
        <select name="role" id="role" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;">
      ...
      <button type="submit" style="padding: 10px 20px; background-color: #007bff; border: none; color: #fff; border-radius: 4px; cursor: pointer;">Login</button>
    </form>
  </div>
</div>
...
<script>
    document.getElementById("loginForm").addEventListener("submit", function (event) {
        ...
        if (role === "user") {
            ...
            form.action = "ProfessionalLoginServlet";
        } else if (role === "admin") {
