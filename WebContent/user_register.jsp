...
<div class="col-lg-6">
  <div class="bg-light text-center rounded p-5" style="background-color: #f8f9fa;">
    <h1 class="mb-4" style="color: #333;">Registration Form</h1>
        <h2 style="color: #007bff;">User Registration Form</h2>

    <form id= "registrationForm" action="user_register" method="post">
      ...
      <div style="margin-bottom: 15px;">
        <label for="phone" style="color: #333;">Phone:</label><br>
        <input type="text" id="phone" name="phone" required style="padding: 10px; width: 100%; border: 1px solid #ccc; border-radius: 4px;">
      </div>
